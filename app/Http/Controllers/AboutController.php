    ...
    public function index(): View
    {
        $team = [
            ...
            [
                ...
                'bio'   => 'Emily\'s eye for detail and passion for creating perfect moments has helped over 300 couples achieve their dream wedding aesthetic.',
                'image' => 'team-coordinator.png',
                'email' => 'emily@skrentals.com',
            ],
            [
                'name'  => 'James Caldwell',
                'role'  => 'Logistics & Operations Manager',
                'bio'   => 'James ensures every delivery is flawless and every item arrives pristine. His team handles setup and breakdown with white-glove care.',
                'image' => 'team-logistics.png',
                'email' => 'james@skrentals.com',
            ],
        ];
