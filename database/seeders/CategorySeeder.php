    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                ...
                'image'       => 'storage/categories/wedding-event-packages.png',
            ],
        ];
