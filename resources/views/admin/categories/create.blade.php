<x-layout.admin-layout>
    ...
    <x-slot:pageTitle>Catalogue / New Category</x-slot:pageTitle>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-3xl font-display font-bold text-neutral-900 tracking-tight">Create Category</h2>
                <p class="text-neutral-400 text-sm mt-1 font-medium">Organize your rental collection</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-neutral-100 overflow-hidden">
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 md:p-10 space-y-8 md:space-y-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4" x-data="{ icon: '📦' }">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="4"
                                      ...
                                      placeholder="What kind of items belong here?">{{ old('description') }}</textarea>
                        </div>
                ...
                <div class="px-6 md:px-10 py-6 md:py-8 bg-neutral-50/50 border-t border-neutral-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p class="text-xs text-neutral-400 font-medium italic text-center sm:text-left">All categories are visible to customers by default.</p>
