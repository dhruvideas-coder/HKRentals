                    ...
                    <div class="p-6 md:p-10 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="number" step="0.01" name="price_per_day" required value="{{ old('price_per_day') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="total_quantity" required value="{{ old('total_quantity') }}"
