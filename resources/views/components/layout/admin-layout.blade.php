...
<head>
    ...
    <title>{{ $title ?? 'Admin' }} — HK Rentals Dashboard</title>
    ...
    <aside class="admin-sidebar" 
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5" aria-label="Admin navigation">
            ...
            <a href="/admin/log-viewer"
               class="admin-nav-item {{ request()->is('admin/log-viewer*') ? 'active' : '' }}">
                <svg class="w-4.5 h-4.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            ...
            <div class="relative" x-data="{ userDropdownOpen: false }">
                ...
                <div x-show="userDropdownOpen" 
                    ...
                    <div class="px-2 py-2">
                        ...
                        <a href="{{ route('admin.profile.show') }}" class="group flex items-center gap-3 px-3 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 rounded-xl transition-all {{ request()->routeIs('admin.profile.*') ? 'bg-blue-50' : '' }}">
                        ...
                        <a href="{{ route('admin.settings.index') }}" class="group flex items-center gap-3 px-3 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 rounded-xl transition-all {{ request()->routeIs('admin.settings.*') ? 'bg-amber-50' : '' }}">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-[11px] text-neutral-500">Delivery & business config</p>
                            </div>
                        </a>
                    </div>
